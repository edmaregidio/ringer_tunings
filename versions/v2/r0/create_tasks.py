...
path = basepath + '/Zee_el/v2/r0'

command = """maestro.py task create \
  -v {PATH} \
  -t user.jodafons.data17_13TeV.AllPeriods.sgn.probes_lhmedium_EGAM1.bkg.VProbes_EGAM7.GRL_v97.v2_el_et{ET}_eta{ETA}.r0 \
  -c user.jodafons.job_config.Zee_v2_el.10sorts.10inits.r0 \
  -d user.jodafons.data17_13TeV.AllPeriods.sgn.probes_lhmedium_EGAM1.bkg.VProbes_EGAM7.GRL_v97_et{ET}_eta{ETA}.npz \
  --sd "{REF}" \
  --exec "run_tuning.py -c %IN -d %DATA -r %REF -v %OUT -b zee_el -t v2 -p r0" \
  --queue "gpu" """
